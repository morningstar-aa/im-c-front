...
private:
	...
	*/
	...
	bool SelClicked(ui::EventArgs* param);
	/**
...
private:
	...
	* 更新版本回调
	*/
	void OnUpdateVerMsgBoxCallback(MsgBoxRet ret);
...
private:
	...
	ui::Control*	user_header_icon_;
	std::wstring urlVersion = L"";

	UnregisterCallback sdk_init_autounreg_cb_;

	ui::Button*		btn_sel_;
	ui::Control*	selaccount_;
	list<ui::HBox*> lisAccount_;
};
