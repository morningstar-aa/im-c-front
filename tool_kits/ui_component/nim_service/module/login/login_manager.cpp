...
namespace
{
	const wchar_t kMutexName[] = L"FeiGeIMNetease.IM.PC.Instance.";
}
...
void LoginManager::SetNickName(const std::string &account)
{
	nick_ = account;
}
void LoginManager::SetLoginName(const std::string &account)
{
	login_ = account; 
}
...
std::string LoginManager::GetLoginName()
{
	return login_;
}

std::string LoginManager::GetNickName()
{
	return nick_;
}
