...
{
/** @class AtMeView
  * @brief 在会话盒子中显示群公告的消息
  * @copyright (c) 2016, NetEase Inc. All rights reserved
  * @author Redrain
  * @date 2016/9/6
  */
class BoardView : public ui::ButtonBox
{
public:
	struct BoardInfo
	{
	...
	* @return void	无返回值
	*/
	void AddMessage(const BoardInfo &at_me_info,const bool tag = true);
...
private:
	...
	* @return void	无返回值
	*/
	void UpdateView(const bool tag = true);
	
private:
	std::vector<BoardInfo>	at_me_info_;
