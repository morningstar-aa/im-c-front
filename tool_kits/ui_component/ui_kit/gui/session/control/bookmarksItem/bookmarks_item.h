...
typedef std::function<void(std::string, ui::ListContainerElement *)> OnDelBookmarksMsgCallback;

namespace nim_comp
{
static const std::wstring kBubbleBox = L"BubbleBox";

/** @class BookmarksBubbleItem
  * @brief 会话窗体中聊天框内的消息项(本类作为各种实际消息项的基类)
  * @copyright (c) 2015, NetEase Inc. All rights reserved
  * @author Redrain
  * @date 2015/9/11
  */
class BookmarksBubbleItem : public ui::ListContainerElement
{
	friend class SessionBox;
public:
	BookmarksBubbleItem();
	virtual ~BookmarksBubbleItem();
...
protected:
	...
	* @return void 无返回值
	*/
	void PopupMenu(ui::EventArgs* arg);
...
protected:
	...
	ui::Button*		msg_header_button*/

private:
	ui::Label*		msg_time_;
	ui::Label*		sender_name_;
	OnDelBookmarksMsgCallback del_fun_;
