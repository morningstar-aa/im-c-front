...
namespace nim_comp
{
	...
	protected:
		...
		*/
		...
		void PopupMenu(bool copy, bool recall, bool retweet = true, bool addemotion = false, bool addBookmarks = false);
		...
		*
		*/
		virtual int CopyFileToClipboard(const char szFileName[]);
