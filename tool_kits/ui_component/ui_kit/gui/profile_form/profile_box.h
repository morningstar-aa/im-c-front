...
private:
	...
	*/
	...
	bool OnIdLoseFocus(ui::EventArgs * args);
	bool OnNameLoseFocus(ui::EventArgs * args);
	/**
	* 处理鼠标进入备注名编辑框消息
	* @param[in] msg 消息的相关信息
	* @return bool true 继续传递控件消息，false 停止传递控件消息
...
private:
	...
	ui::RichEdit*		show_name_label = NULL;//cjy2
	ui::RichEdit*		user_id_label = NULL;//cjy
	ui::RichEdit*		user_name_label = NULL;//cjy
	ui::RichEdit*		nickname_label = NULL;
