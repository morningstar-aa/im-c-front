...
namespace nim_comp
{
	...
	public:
		...
		** 新建会话窗口
		*/
		void NewSessionForm(nim::SessionData item_msg);
	private:
		/**
	...
	public:
		...
		* 从本地数据库获取@所有人次数
		*/
		void GetForcePushFromDB();

		/*
		* 向服务器提交建群信息
		*/
		//void SaveCreateTeamInfo(const nim::TeamEvent& result);

		bool IsActiveMainForm();
