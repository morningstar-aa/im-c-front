...
void LoginManager::SetClientSetting(const std::map<std::string, std::string> &map_)
{
	return nim_comp::LoginManager::GetInstance()->SetClientSetting(map_);
}

std::map<std::string, std::string> & LoginManager::GetClientSetting()
{
	return nim_comp::LoginManager::GetInstance()->GetClientSetting();
}

bool LoginManager::GetIsFristRun()
{
	return nim_comp::LoginManager::GetInstance()->GetIsFristRun();
}

void LoginManager::SetIsFristRun(bool isFristRun)
{
	nim_comp::LoginManager::GetInstance()->SetIsFristRun(isFristRun);
}

void LoginManager::SetAccountToken(const std::string& token)
{
	nim_comp::LoginManager::GetInstance()->SetAccountToken(token);
}

std::string LoginManager::GetAccountToken()
{
	return nim_comp::LoginManager::GetInstance()->GetAccountToken();
}
