...
std::list<std::string> SessionListManager::GetAllSession(bool qun)
{
	return session_list_->GetAllSession(qun);
}
...
void SessionListManager::UpDownSessionItem(bool flag)
{
	session_list_->UpDownSessionItem(flag);
}

void SessionListManager::DeleteLatestContact(std::string team_id)
{
	session_list_->DeleteLatestContact(team_id);
}

//SessionBox * SessionListManager::getActiveSessionBox()
//{
//	session_list_->ge
//}
}
