...
public:
	...
	* @return void	无返回值
	*/
	static void OnTeamEventCallbackEx(const int type, const nim::TeamInfo tInfo, const nim::TeamEvent& result);

	//void UITeamCreateCallback(int res, const std::string& err_msg);
	/**
	...
	*
	*/
	static void QueryTeamInfoCallback(const std::string& tid, const nim::TeamInfo& result);
};
