...
public:
	...
	///** 设置普通群成员添加好友权限 */
	void SetMemberAddFriendMode(NIMTeamMemberAddFriendMode mode)
	{
		team_info_json_value_[nim::kNIMTeamInfoKeyMemberaddfriend] = mode;
	}

	/** 获取普通群成员添加好友权限 */
	NIMTeamMemberAddFriendMode GetMemberAddFriendMode() const
	{
		return (NIMTeamMemberAddFriendMode)team_info_json_value_[nim::kNIMTeamInfoKeyMemberaddfriend].asUInt();
	}
...
private:
	...
	NIMTeamMemberAddFriendMode team_info_member_addfriend_;
};
