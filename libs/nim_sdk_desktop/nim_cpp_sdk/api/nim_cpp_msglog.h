...
public:
	...
	typedef std::function<void(nim::NIMResCode res_code, const std::string& id, nim::NIMSessionType to_type, const QueryMsglogResult& result)> QueryMsgOnlineCallback; /**< 查询消息历史回调模板 */
	...
	typedef std::function<void(const nim::NIMResCode res_code,const std::string& accid)>	DeleteHistoryOnLineAsyncCallback;	/**< 删除与某账号的所有云端历史记录与漫游消息的回调模板 */
